...
import { LiquidGlassEffect } from './effects/liquid_glass_effect.js';
...
export let Dock = GObject.registerClass(
  {},
  class LiquidDashAnimated extends St.Widget {
    _init(params) {
      super._init({
        // name: 'ldaDock',
      ...
      this._background = new DockBackground({ name: 'ldaBackground' });
      this.add_child(this._background);

      this._liquidGlassEffect = new LiquidGlassEffect();
      this._liquidGlassEffect.preload(this.extension.path);
      this._background.add_effect_with_name('liquid-glass', this._liquidGlassEffect);
    ...
    _updateExtraIcons() {
      ...
      let folders = [
        {
          ...
          path: `${this.extension.path}/apps/recents-liquid-dash-animated.desktop`,
        ...
        },
        {
          ...
          //! find a way to avoid this
          path: tempPath('downloads-liquid-dash-animated.desktop'),
      ...
      if (!this._trashIcon && this.extension.trash_icon) {
        ...
        this._trashIcon = this.createItem(
          tempPath('trash-liquid-dash-animated.desktop')
        );
        this._icons = null;
    ...
    animate(dt = 15) {
      if (this._liquidGlassEffect) {
        this._liquidGlassEffect.set_dock_parameters(
          this._background.x,
          this._background.y,
