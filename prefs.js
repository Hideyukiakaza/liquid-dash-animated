...
const GETTEXT_DOMAIN = 'liquid-dash-animated';
...
export default class Preferences extends ExtensionPreferences {
    ...
    const actions = [
      {
        ...
        link: 'https://github.com/Hideyukiakaza/liquid-dash-animated/issues',
      },
      {
        name: 'open-readme',
        link: 'https://github.com/Hideyukiakaza/liquid-dash-animated',
      },
      {
        name: 'open-buy-coffee',
        link: 'https://www.buymeacoffee.com/Hideyukiakaza',
      },
      {
        name: 'open-license',
        link: 'https://github.com/Hideyukiakaza/liquid-dash-animated/blob/master/LICENSE',
      },
    ];
  ...
  fillPreferencesWindow(window) {
    ...
    if (builder.get_object('qr')) {
      builder
        .get_object('qr')
        .set_from_file(`${UIFolderPath}/images/qr_Hideyukiakaza.png`);
    }
    ...
    this.preloadPresets(
      Gio.File.new_for_path('.config/lda/themes').get_path()
    );
